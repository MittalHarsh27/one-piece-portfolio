...
interface TimelineEvent {
  ...
  icon: React.ReactNode;         /* Icon to represent the milestone */
...
export default function About() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen bg-gradient-to-b from-black via-blue-900/20 to-black py-20 overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
            {timelineEvents.map((event, index) => (
              ...
              >
                <div
                  className={cn(
                    "relative p-6 bg-black/90 backdrop-blur-sm rounded-xl shadow-lg border-2 transition-all duration-300",
                    "hover:shadow-xl hover:scale-105 max-w-md",
                    activeEvent === event.id
                      ? "border-straw-hat shadow-straw-hat/20"
                      : "border-blue-400/50 hover:border-straw-hat"
                  )}
                >
                  ...
                  <div className="absolute top-4 right-4">
                    <span className="px-3 py-1 bg-straw-hat/20 text-straw-hat rounded-full text-sm font-bold">
                      {event.year}
                    </span>
                  </div>
                  ...
                  <div className="pt-4">
                    <h3 className="font-manga text-xl text-straw-hat mb-3">
                      {event.title}
                    </h3>
                    ...
                    {event.achievements && (
                      <div className="space-y-2">
                        <h4 className="font-semibold text-sm text-straw-hat uppercase tracking-wide">
                          Key Skills Acquired:
                        </h4>
                        <div className="flex flex-wrap gap-2">
                          {event.achievements.map((achievement, i) => (
                            <motion.span
                              key={i}
                              className="px-3 py-1 bg-straw-hat/20 text-straw-hat rounded-full text-xs font-medium"
                              initial={{ scale: 0 }}
                  ...
                  <div className="hidden lg:block absolute top-1/2 -translate-y-1/2">
                    {index % 2 === 0 ? (
                      <div className="absolute -right-8 w-8 h-0.5 bg-gradient-to-r from-blue-400 to-straw-hat" />
                    ) : (
                      <div className="absolute -left-8 w-8 h-0.5 bg-gradient-to-l from-blue-400 to-straw-hat" />
                    )}
                  </div>
                </div>
              </motion.div>
          ...
          <div className="hidden lg:block absolute top-1/2 left-1/2 w-1 h-full bg-gradient-to-b from-straw-hat via-blue-400 to-straw-hat transform -translate-x-1/2" />
        </div>
        ...
        >
          <div className="bg-black/90 backdrop-blur-sm rounded-xl p-8 max-w-4xl mx-auto border border-straw-hat/20 relative overflow-hidden">
            ...
            <motion.div
              className="w-16 h-16 bg-straw-hat rounded-full flex items-center justify-center mx-auto mb-6 relative z-10"
              animate={{ rotate: 360 }}
            ...
            <h3 className="font-manga text-2xl text-straw-hat mb-4 relative z-10">
            ...
            <motion.div
              className="absolute bottom-4 right-4 text-straw-hat/30"
